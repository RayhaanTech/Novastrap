...
<img src="https://raw.githubusercontent.com/voidstrap/Novastrap/main/Bloxstrap/Novastrap.png" alt="preview" width="100px"/>
</a>
</p>

<h1 align="center"><b>Novastrap</b></h1>
...
<p align="center">
  <a href="github.com/voidstrap/Novastrap/releases/latest">Latest release</a> |
...
> [!IMPORTANT]
> Novastrap currently supports **Windows 10 and above**.  
...
1. Download the latest version
   👉 https://github.com/voidstrap/Novastrap/releases/latest
...
<details>
  ...
  No. Novastrap does not inject cheats, exploits, or bypass Roblox security.  
...
<details>
  ...
  No. Novastrap is fully open-source, meaning anyone can inspect the code.  
  ...
  https://github.com/voidstrap/Novastrap
...
Novastrap is built using **C# and .NET**.
...
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <td style="width: 33%; text-align: left;">© Novastrap</td>
    <td style="width: 33%; text-align: right;"><a href="https://github.com/voidstrap/Novastrap/blob/main/LICENSE.VOIDSTRAP" target="_blank">MIT</a></td>
  </tr>
</table>
...
> [!NOTE]
> Novastrap is still in **early development**, even though the project has existed for over **2 years**.  
> Features may change and some things may still be unfinished.

[shield-repo-downloads]:  https://img.shields.io/github/downloads/voidstrap/Novastrap/latest/total?color=981bfe
[shield-repo-total]:      https://img.shields.io/github/downloads/voidstrap/Novastrap/total?color=8a2be2
[shield-repo-latest]:     https://img.shields.io/github/v/release/voidstrap/Novastrap?color=7a39fb
[shield-repo-stars]:      https://img.shields.io/github/stars/voidstrap/Novastrap?color=ffd700
...
[repo-releases]:          https://github.com/voidstrap/Novastrap/releases
