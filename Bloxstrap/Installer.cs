...
namespace Novastrap
{
    internal class Installer
    {
        ...
        public bool CreateDesktopShortcuts = false;
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs Novastrap, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "1.0.3.6") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Novastrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Novastrap", false);
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-Novastrap-v{currentVer}");
