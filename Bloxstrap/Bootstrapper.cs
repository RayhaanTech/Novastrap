...
using Strings = Novastrap.Resources.Strings;
...
using Novastrap.AppData;
using Novastrap.Integrations;
using Novastrap.RobloxInterfaces;
using Novastrap.UI.Elements.Bootstrapper.Base;
using Novastrap.UI.ViewModels.Settings;
using static Novastrap.UI.ViewModels.Settings.ModsViewModel;
...
namespace Novastrap
{
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            try
            {
                using (Mutex.OpenExisting("Novastrap-Bootstrapper"))
                {
                    App.Logger.WriteLine(LOG_IDENT, "Novastrap-Bootstrapper mutex exists, waiting...");
            ...
            await using var mutex = new AsyncMutex(false, "Novastrap-Bootstrapper");
        ...
        private async Task CheckAndApplyUpdate(string logIdent)
        {
            ...
            if (ok)
            {
                App.Logger.WriteLine(logIdent, "Update installed restarting Novastrap...");
                RestartApplication();
            }
            else
            {
