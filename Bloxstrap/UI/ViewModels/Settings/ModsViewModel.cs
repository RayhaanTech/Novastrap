...
using static Novastrap.UI.Elements.Settings.Pages.ModsPage;

namespace Novastrap.UI.ViewModels.Settings
{
    ...
    GetVisibility(Path.Combine(Paths.Mods, "Content", "textures", "Cursors", "KeyboardMouse"),
        ...
        private readonly string _dir =
            Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Novastrap");
