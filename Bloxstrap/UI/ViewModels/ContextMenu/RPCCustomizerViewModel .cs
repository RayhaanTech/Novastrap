...
namespace Novastrap.UI.ViewModels.ContextMenu
{
    public class RPCCustomizerViewModel : INotifyPropertyChanged
    {
        ...
        private string _appName = "Novastrap";
        ...
        private void UpdatePresence()
        {
            ...
            try
            {
                ...
                {
                    Details = string.IsNullOrWhiteSpace(Details) ? "Using Novastrap" : Details,
                    State = State,
                    Assets = new Assets
                    {
