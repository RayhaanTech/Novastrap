...
using Novastrap.UI.ViewModels.Bootstrapper;
using System;
...
namespace Novastrap.UI.Elements.Bootstrapper
{
    public partial class FluentDialog : IBootstrapperDialog
    {
        ...
        public Novastrap.Bootstrapper? Bootstrapper { get; set; }
        ...
        public FluentDialog(bool aero)
        {
            ...
            .OfType<Novastrap.UI.Elements.Settings.MainWindow>()
            .FirstOrDefault();
            if (App.Settings.Prop.BackgroundWindow)
            {
                _mainWindow?.Hide();
            }
            Novastrap.UI.Elements.Bootstrapper.AudioPlayerHelper.PlayStartupAudio();
            this.Closed += (s, e) =>
            {
                _mainWindow = System.Windows.Application.Current.Windows
                .OfType<Novastrap.UI.Elements.Settings.MainWindow>()
                ...
                Novastrap.UI.Elements.Bootstrapper.AudioPlayerHelper.StopAudio();
            };
