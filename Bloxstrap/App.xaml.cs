...
using Novastrap.UI.Elements.Bootstrapper;
...
namespace Novastrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Novastrap-QA";
#else
        public const string ProjectName = "Novastrap";
#endif
        public const string ProjectOwner = "Novastrap";
        public const string ProjectRepository = "/voidstrap/Novastrap/";
        public const string ProjectDownloadLink = "https://github.com/voidstrap/Novastrap/releases";
        public const string ProjectHelpLink = "https://github.com/BloxstrapLabs/Bloxstrap/wiki";
        public const string ProjectSupportLink = "https://github.com/voidstrap/Novastrap/issues/new";
        ...
        public static void AssertWindowsOSVersion()
        {
            ...
            if (major < 7)
            {
                ...
                if (!LaunchSettings.QuietFlag.Active)
                    Frontend.ShowMessageBox("Your Windows Version is not supported with Novastrap!", MessageBoxImage.Error);
