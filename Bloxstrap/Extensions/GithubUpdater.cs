...
public static class GithubUpdater
{
    ...
    {
        DefaultRequestHeaders = { { "User-Agent", "Novastrap-Updater" } }
    };
    ...
    public static async Task<string?> GetLatestVersionTagAsync()
    {
        try
        {
            string url = "https://github.com/RayhaanTech/Novastrap/releases/latest";
    ...
    private static async Task<bool> UpdateZip(string url, string name)
    {
        ...
        string mainExe = Path.Combine(currentDir, "Novastrap.exe");
